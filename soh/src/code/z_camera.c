...
s32 Camera_Free(Camera* camera) {
    ...
    f32 newCamX = -D_8015BD7C->state.input[0].cur.right_stick_x * 10.0f * (CVarGetFloat(CVAR_SETTING("FreeLook.CameraSensitivity.X"), 1.0f)) - mouse_cur_x * MOUSE_CAM_X_SENSITIVITY;
    f32 newCamY = D_8015BD7C->state.input[0].cur.right_stick_y * 10.0f * (CVarGetFloat(CVAR_SETTING("FreeLook.CameraSensitivity.Y"), 1.0f)) + mouse_cur_y * MOUSE_CAM_Y_SENSITIVITY;
