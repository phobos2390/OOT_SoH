...
const std::vector<FlagTable> flagTables = {
    ...
    { "Randomizer Inf Flags",
      ...
      (RAND_INF_MAX + 15) / 16,
      {
          ...
          { RAND_INF_HF_BOULDER_1, "RAND_INF_HF_BOULDER_1" },
          { RAND_INF_HF_BOULDER_2, "RAND_INF_HF_BOULDER_2" },
          { RAND_INF_HF_BOULDER_3, "RAND_INF_HF_BOULDER_3" },
          ...
          { RAND_INF_GC_MAZE_SILVER_BOULDER_30, "RAND_INF_GC_MAZE_SILVER_BOULDER_30" },
        ...
        { RAND_INF_HF_TREE_YELLOW_GROTTO_TREE, "RAND_INF_HF_TREE_YELLOW_GROTTO_TREE" },
