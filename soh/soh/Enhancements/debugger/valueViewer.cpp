...
std::vector<ValueTableElement> valueTable = {
    ...
    { "Link Yaw",           "Player->actor.world.rot.y",            "ROTY:",   TYPE_S16,   true,  []() -> void* { return &GET_PLAYER(gPlayState)->actor.world.rot.y; }, WHITE },
    { "Link Pitch",         "Player->actor.world.rot.x",            "ROTX:",   TYPE_S16,   true,  []() -> void* { return &GET_PLAYER(gPlayState)->actor.world.rot.x; }, WHITE },
    { "Link Focus Yaw",     "Player->actor.focus.rot.y",            "FOCY:",   TYPE_S16,   true,  []() -> void* { return &GET_PLAYER(gPlayState)->actor.focus.rot.y; }, WHITE },
