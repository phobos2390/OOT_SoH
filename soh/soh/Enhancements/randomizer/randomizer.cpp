...
std::map<RandomizerCheck, RandomizerInf> rcToRandomizerInf = {
    ...
    { RC_HF_BOULDER_1, RAND_INF_HF_BOULDER_1 },
    { RC_HF_BOULDER_2, RAND_INF_HF_BOULDER_2 },
    { RC_HF_BOULDER_3, RAND_INF_HF_BOULDER_3 },
    ...
    { RC_GC_MAZE_SILVER_BOULDER_30, RAND_INF_GC_MAZE_SILVER_BOULDER_30 },
        ...
        if (ImGui::BeginTabItem("Tricks/Glitches")) {
            ...
            if (ImGui::BeginTable("tableRandoLogic", 1, ImGuiTableFlags_BordersH | ImGuiTableFlags_BordersV)) {
                ...
                if (CVarGetInteger(CVAR_RANDOMIZER_SETTING("LogicRules"), RO_LOGIC_GLITCHLESS) != RO_LOGIC_GLITCHLESS ||
                    CVarGetInteger(CVAR_RANDOMIZER_SETTING("LogicRules"), RO_LOGIC_GLITCHLESS) != RO_LOGIC_NEARLY_NO_LOGIC) {
                    ImGui::SameLine();
