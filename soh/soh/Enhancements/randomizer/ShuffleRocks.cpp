...
#define BOLDLOC(id, area, scene, hint, x, z)                                                                           \
    ...
    BOLDLOC(HF_BOULDER_1, RCAREA_HYRULE_FIELD, SCENE_HYRULE_FIELD, RHT_HF_BOULDER, -4450, -425);
    BOLDLOC(HF_BOULDER_2, RCAREA_HYRULE_FIELD, SCENE_HYRULE_FIELD, RHT_HF_BOULDER, -1425, 810);
    BOLDLOC(HF_BOULDER_3, RCAREA_HYRULE_FIELD, SCENE_HYRULE_FIELD, RHT_HF_BOULDER, -270, 12350);
    ...
    BOLDLOC(GC_MAZE_SILVER_BOULDER_30, RCAREA_GORON_CITY, SCENE_GORON_CITY, RHT_GC_SILVER_BOULDER, -1197, -1329);
